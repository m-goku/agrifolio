                    ...
                    <ul>
                        <li className="mb-4">
                            <button
                                ...
                                className={` text-xl font-medium  ${activeTab === "home"
                                    ? " text-green-700"
                        ...
                        <li className="mb-4">
                            <button
                                ...
                                className={` text-xl font-medium  ${activeTab === "about"
                                    ? " text-green-700"
                                    : " text-gray-400 hover:text-green-800 "
                                    }`}
                            >
                        ...
                        <li className="mb-4">
                            <button
                                ...
                                className={` text-xl font-medium  ${activeTab === "gallery"
                                    ? " text-green-700"
                                    : " text-gray-400 hover:text-green-800 "
                                    }`}
                            >
                        ...
                        <li className="mb-4">
                            <button
                                ...
                                className={` text-xl font-medium  ${activeTab === "products"
                                    ? " text-green-700"
                                    : " text-gray-400 hover:text-green-800 "
                                    }`}
                            >
                        ...
                        <li>
                            <button
                                ...
                                className={` text-xl font-medium  ${activeTab === "contact"
                                    ? " text-green-700"
                                    : " text-gray-400 hover:text-green-800 "
                                    }`}
                            >
