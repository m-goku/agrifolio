    ...
    const getData = async () => {
      try {
        const response = await fetch(
          `https://agrifolio-backend.onrender.com/profile/create`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
              token:
                "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NzNkNTM1ZmJjNGU4YWUxZTEyNTE2NGUiLCJpYXQiOjE3MzIwNzI1MDF9.3PglpgyTtY0bldzVaET37_gubAmCk2L4zrlvUsrTZMg",
            },
          }
        );
